...
email_id = "g@example.com"
is_email_valid = "@" in email_id
...
print("Can the user login : ",can_login)
print("Is the email valid : ",is_email_valid)
print("Is the age valid : ",is_age_valid)
print("user can login finally : ",can_login_final)

print("User has an account : ",has_account is True)
...
# Print the following results: is_logged_in, is_subscribed, credits_valid, bonus_eligible, 
# user_credits, power_result, full_access, is_true_login, and access_result.
...
print(f"Is credits valid : {credits_valid}")
print(f"Is Bonus eligible : {bonus_eligible}")
print(f"User credits = {user_credits}")
print(f"Power result = {power_result}")
print(f"Full access ? : {full_access}")
print(f"Is true login  : {is_true_login}")
